          ...
          <div className="space-y-4">
            {!useEmailAuth ? (
              <>
                ...
                <button
                  ...
                  className="w-full text-center text-xs text-gray-500 hover:text-brand-navy font-bold py-1 cursor-pointer"
                >
              ...
              <form onSubmit={handleEmailLogin} className="space-y-3">
                <div className="space-y-1 text-left">
                  <label className="text-[10px] font-bold text-gray-500 uppercase block">Correo Electrónico</label>
                  <input
                    type="email"
                    required
                    placeholder="marfamishop@gmail.com"
                    value={loginEmail}
                    onChange={(e) => setLoginEmail(e.target.value)}
                    className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs text-gray-800 focus:border-brand-purple focus:outline-hidden"
                  />
                </div>

                <div className="space-y-1 text-left">
                  <label className="text-[10px] font-bold text-gray-500 uppercase block">Contraseña</label>
                  <input
                    type="password"
                    required
                    placeholder="••••••••"
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-11 rounded-xl bg-brand-navy hover:bg-brand-blue text-white font-bold text-xs transition-all shadow-md cursor-pointer disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className="w-full text-center text-xs text-gray-400 hover:text-gray-600 font-bold py-1 cursor-pointer block"
                >
            ...
            {!isRealSupabaseConfigured && (
              <p className="text-[10px] text-amber-600 text-center font-medium bg-amber-50 rounded-lg p-2.5 border border-amber-100 leading-relaxed">
                <strong>Modo Simulado Activo:</strong> El botón iniciará sesión automáticamente como <code className="bg-white/70 px-1 rounded font-mono">marfamishop@gmail.com</code> para pruebas locales.
              </p>
            )}
          </div>
